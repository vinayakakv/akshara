...
export const LanguageProcessingTools = () => {
  ...
  return (
    <div
      className={twMerge(
        'h-full flex flex-col p-4 gap-4 overflow-hidden',
        !transliterateApi && 'pointer-events-none opacity-50',
      )}
    >
